 ...
 * 
 * This is the producer, it just pushes a message to the end of the topic stream.
 */
...
import { MongoTopicMessage, MongoTopicMessageDocument, SequenceDocument } from "./types";
...
export class TopicProducer<T> {
    ...
    private async getNextId() : Promise<number> {
        ...
        const result = await this.client.db(this.databaseName).collection<SequenceDocument>("nextids").findOneAndUpdate({
    ...
    public async pushMessageToTopic(message: MongoTopicMessage<T>): Promise<void> {
